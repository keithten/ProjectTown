...
#include "ApparanceUnrealVersioning.h"	//APPARANCE: class renamed
#if UE_VERSION_AT_LEAST( 5, 0, 0 ) 	//local copies to fix a bug (UE 5.0 version)
#include "SVectorInputBoxFix5.0.h"
#else
 ...
 */
class SVectorInputBoxFix : public SCompoundWidget	//APPARANCE: class renamed
{
public:
	SLATE_BEGIN_ARGS( SVectorInputBoxFix )	//APPARANCE: class renamed
