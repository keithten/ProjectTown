...
#include "ApparanceUnrealVersioning.h"	//APPARANCE: local copies to fix a bug
#if UE_VERSION_AT_LEAST( 5, 0, 0 )	 	//APPARANCE: across versions
# if UE_VERSION_AT_LEAST( 5, 4, 0 )
#  include "SNumericEntryBoxFix5.4.h"
# elif UE_VERSION_AT_LEAST( 5, 3, 0 )
#  include "SNumericEntryBoxFix5.3.h"
# elif UE_VERSION_AT_LEAST( 5, 1, 0 )
#  include "SNumericEntryBoxFix5.1.h"
#else UE_VERSION_AT_LEAST( 5, 0, 0 )
#  include "SNumericEntryBoxFix5.0.h"
# endif
#else									//...APPARANCE
...
class SNumericEntryBoxFix : public SCompoundWidget	//APPARANCE: fixed version named differently to avoid clash
{
public:
	...
	void Construct( const FArguments& InArgs )
	{
		...
		if(bAllowSpin)
		{
			SAssignNew( SpinBox, SSpinBox<NumericType> )
				...
				.ToolTipText( this, &SNumericEntryBoxFix<NumericType>::GetValueAsText );			 //APPARANCE: class renamed
		}
